...
export default function Hero() {
  return (
    ...
    >
      ...
      <Blob className="-right-24 bottom-0 h-[28rem] w-[28rem]" tone="deep" delay={0.3} />
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-16 px-6 py-16 lg:grid-cols-2 lg:px-10">
        <div>
          <motion.p
            ...
            animate="show"
            custom={0}
            className="mb-5 inline-flex items-center rounded-full border border-lavender-200 bg-white/70 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-lavender-700"
          >
        ...
        >
          ...
          >
            <img
              src={productJar}
              alt="goPure Tighten & Lift Neck Cream, frasco de 50 ml"
          ...
          <motion.div
            ...
            className="glass absolute -left-6 top-10 hidden rounded-3xl px-5 py-4 shadow-soft sm:block"
          >
            <p className="font-display text-2xl font-medium text-lavender-700">4%</p>
          ...
          <motion.div
            ...
            className="glass absolute -right-4 bottom-16 hidden rounded-3xl px-5 py-4 shadow-soft sm:block"
          >
            <p className="font-display text-2xl font-medium text-lavender-700">2.5%</p>
